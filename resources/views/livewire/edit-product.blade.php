            ...
            <form wire:submit.prevent="updateProduct">
                ...
                <div
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <input wire:model="name" value="{{$productDetails->name}}" id="af-submit-application-full-name" type="text"
                    ...
                    <div class="sm:col-span-9">
                        <select wire:model="category_id" id="af-submit-application-category"
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" wire:key="{{ $category->id }}" {{ $category_id == $category->id ? 'selected' : '' }}>{{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div
                    ...
                    <div class="sm:col-span-9">
                        @if ($photo && is_string($photo))
                            <img src="{{ Storage::url($photo) }}" width="300" height="300" />
                        @elseif ($photo)    
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove>Click to Update</span>
